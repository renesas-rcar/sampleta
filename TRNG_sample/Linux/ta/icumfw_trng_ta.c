...
void generate_and_show_trng( void* buf, size_t buf_len);
		...
		void __maybe_unused **sess_ctx)
{
	...
	IMSG("ICUM TEST: True Random Number Generaion service!\n");
